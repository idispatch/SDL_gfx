...
static char *fontfile[NUM_SDLGFX_FONTS] = { "", "5x7.fnt", "7x13.fnt", "7x13B.fnt", "7x13O.fnt",
        "9x18.fnt", "9x18B.fnt", };

/* Width of font characters */
static int fontw[NUM_SDLGFX_FONTS] = { 8, 5, 7, 7, 7, 9, 9, };

/* Height of fonts characters */
static int fonth[NUM_SDLGFX_FONTS] = { 8, 7, 13, 13, 13, 18, 18, };

/* Bytes of fontfiles */
static int fontsize[NUM_SDLGFX_FONTS] = { 0, 1792, 3328, 3328, 3328, 9216, 9216, };
...
void Draw(SDL_Surface *screen) {
    ...
    for (i = 0; i < NUM_SDLGFX_FONTS; i++) {
        fprintf(stderr, "Drawing Font: size %ix%i, file '%s', %i bytes, rotation %i\n", fontw[i],
                fonth[i], fontfile[i], fontsize[i], rotation);
        /* Reset line pos */
        x = 4;
        myfont = NULL;
        if (i > 0) {
...
int main(int argc, char *argv[]) {
    ...
    sprintf(title, "TestFonts - v%i.%i.%i", SDL_GFXPRIMITIVES_MAJOR, SDL_GFXPRIMITIVES_MINOR,
